...
/*
    ...
    전자      4
*/
SELECT category AS 카테고리, COUNT(buy_no) AS 구매횟수
FROM tbl_product p 
...
/*
    ...
    PSH     3
*/
SELECT user_id AS 아이디, COUNT(buy_no) AS 구매횟수
FROM tbl_user u 
INNER JOIN tbl_buy b
...
/*
    ...
    YJS     유재석  0
*/
SELECT user_id AS 아이디, user_name AS 고객명, COUNT(b.buy_no) AS 구매횟수
FROM tbl_user u
...
/*
    ...
    벨트    0개
*/
SELECT prod_name AS 상품명, CONCAT(COUNT(b.buy_no), "개") AS 판매횟수
FROM tbl_product p 
LEFT OUTER JOIN tbl_buy b
ON p.prod_code = b.prod_code
GROUP BY prod_name;
...
/*
    ...
    박수홍  메모리  800
*/
SELECT user_name AS 고객명, prod_name AS 상품명, prod_price * buy_amount AS 구매액
FROM tbl_user u 
INNER JOIN tbl_buy b
ON u.user_no = b.user_no 
...
/*
    ...
    LHJ     이휘재  2         80
*/
SELECT user_id AS 아이디, user_name AS 고객명, COUNT(b.buy_no) AS 구매횟수, SUM(prod_price * buy_amount) AS 총구매액
FROM tbl_user u 
INNER JOIN tbl_buy b
ON u.user_no = b.user_no 
INNER JOIN tbl_product p
...
/*
    ...
    박수홍  3
*/
SELECT user_name AS 고객명, COUNT(b.buy_no) AS 구매횟수
FROM tbl_user u 
INNER JOIN tbl_buy b
ON u.user_no = b.user_no
GROUP BY user_name
...
/*
    ...
    유재석   NULL
*/
SELECT user_name AS 고객명, prod_name AS 구매상품
FROM tbl_user u 
LEFT OUTER JOIN tbl_buy b
ON u.user_no = b.user_no 
...
DELETE
FROM tbl_buy
WHERE buy_no = (SELECT m.max_buy_no 
